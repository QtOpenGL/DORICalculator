...
bool SceneManager::init()
{
    ...
    suzanne->setPosition(-5, 10, 0);
    suzanne->setColor(1, 0, 1);
    mObjects << suzanne;

    mCamera = new Camera;
    mLight = new Light;
    mCamera->setPosition(10, 5, 5);
    mLight->setPosition(2, 10, 2);
...
void SceneManager::render() { mRenderer->render(mObjects, mCamera, mLight); }
...
void SceneManager::mousePressEvent(QMouseEvent *) { mMousePressed = true; }
